...
namespace Jivaro_Old_School_RuneScape_Bot_Manager
{
    partial class formMainForm
    {
        ...
        public void InitializeComponent()
        {
            ...
            kryptonTextBoxDashboard_ScriptFactoryManager_BreakTime = new Krypton.Toolkit.KryptonTextBox();
            labelDashboard_ScriptFactoryManager_RunTimeMins = new Label();
            kryptonTextBoxDashboard_ScriptFactoryManager_RunTime = new Krypton.Toolkit.KryptonTextBox();
            labelDashboard_ScriptFactoryManager_BreakTime = new Label();
            kryptonCheckBoxDashboard_ScriptFactoryManager_Loop = new Krypton.Toolkit.KryptonCheckBox();
            labelDashboard_ScriptFactoryManager_RunTime = new Label();
            kryptonListBoxDashboard_ScriptFactoryManager_AdditionalSettings = new Krypton.Toolkit.KryptonListBox();
            labelDashboard_ScriptFactoryManager_AdditionalSettings = new Label();
            kryptonButtonDashboard_ScriptFactoryManager_Save = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount = new Krypton.Toolkit.KryptonButton();
            ...
            kryptonTextBoxDashboard_OSBotManager_RunTime = new Krypton.Toolkit.KryptonTextBox();
            labelDashboard_OSBotManager_BreakTime = new Label();
            kryptonCheckBoxDashboard_OSBotManager_Loop = new Krypton.Toolkit.KryptonCheckBox();
            labelDashboard_OSBotManager_RunTime = new Label();
            kryptonListBoxDashboard_OSBotManager_AdditionalSettings = new Krypton.Toolkit.KryptonListBox();
            labelDashboard_OSBotManager_AdditionalSettings = new Label();
            kryptonButtonDashboard_OSBotManager_Save = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_OSBotManager_DownloadClient = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_OSBotManager_ImportAccounts = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_OSBotManager_DeleteAccount = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_OSBotManager_AddAccount = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_OSBotManager_LaunchOSBot = new Krypton.Toolkit.KryptonButton();
            kryptonDataGridViewDashboard_OSBotManager = new Krypton.Toolkit.KryptonDataGridView();
            kryptonDataGridViewDashboard_OSBotManager_Account = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_Password = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_Pin = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_Proxy = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_Script = new DataGridViewComboBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_Args = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_World = new DataGridViewComboBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_RunStop = new DataGridViewButtonColumn();
            kryptonDataGridViewDashboard_OSBotManager_Notes = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_Status = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber = new DataGridViewTextBoxColumn();
            kryptonPageDashboard_DreamBotManager = new KryptonPage();
            labelButtonDashboard_DreamBotManager_BreakTimeMins = new Label();
            kryptonTextBoxButtonDashboard_DreamBotManager_BreakTime = new Krypton.Toolkit.KryptonTextBox();
            labelButtonDashboard_DreamBotManager_RunTimeMins = new Label();
            kryptonTextBoxButtonDashboard_DreamBotManager_RunTime = new Krypton.Toolkit.KryptonTextBox();
            labelButtonDashboard_DreamBotManager_BreakTime = new Label();
            kryptonCheckBoxButtonDashboard_DreamBotManager_Loop = new Krypton.Toolkit.KryptonCheckBox();
            labelButtonDashboard_DreamBotManager_RunTime = new Label();
            kryptonListBoxDashboard_DreamBotManager_AdditionalSettings = new Krypton.Toolkit.KryptonListBox();
            labelButtonDashboard_DreamBotManager_AdditionalSettings = new Label();
            kryptonButtonButtonDashboard_DreamBotManager_Save = new Krypton.Toolkit.KryptonButton();
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient = new Krypton.Toolkit.KryptonButton();
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts = new Krypton.Toolkit.KryptonButton();
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount = new Krypton.Toolkit.KryptonButton();
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot = new Krypton.Toolkit.KryptonButton();
            kryptonDataGridViewDashboard_DreamBotManager = new Krypton.Toolkit.KryptonDataGridView();
            kryptonDataGridViewDashboard_DreamBotManager_Account = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_Password = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_Pin = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_Proxy = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_Script = new DataGridViewComboBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_Args = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_Breaks = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_World = new DataGridViewComboBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_RunStop = new DataGridViewButtonColumn();
            kryptonDataGridViewDashboard_DreamBotManager_Notes = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_Status = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber = new DataGridViewTextBoxColumn();
            kryptonPageDashboard_TRiBotManager = new KryptonPage();
            labelDashboard_TRiBotManager_BreakTimeMins = new Label();
            kryptonTextBoxDashboard_TRiBotManager_BreakTime = new Krypton.Toolkit.KryptonTextBox();
            labelDashboard_TRiBotManager_RunTimeMins = new Label();
            kryptonTextBoxDashboard_TRiBotManager_RunTime = new Krypton.Toolkit.KryptonTextBox();
            labelDashboard_TRiBotManager_BreakTime = new Label();
            kryptonCheckBoxDashboard_TRiBotManager_Loop = new Krypton.Toolkit.KryptonCheckBox();
            labelDashboard_TRiBotManager_RunTime = new Label();
            kryptonListBoxDashboard_TRiBotManager_AdditionalSettings = new Krypton.Toolkit.KryptonListBox();
            labelDashboard_TRiBotManager_AdditionalSettings = new Label();
            kryptonButtonDashboard_TRiBotManager_Save = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_TRiBotManager_DownloadClient = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_TRiBotManager_ImportAccounts = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_TRiBotManager_DeleteAccount = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_TRiBotManager_AddAccount = new Krypton.Toolkit.KryptonButton();
            kryptonButtonDashboard_TRiBotManager_LaunchClient = new Krypton.Toolkit.KryptonButton();
            kryptonDataGridViewDashboard_TRiBotManager = new Krypton.Toolkit.KryptonDataGridView();
            kryptonDataGridViewDashboard_TRiBotManager_Account = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_Password = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_Pin = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_Proxy = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_Script = new DataGridViewComboBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_Args = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_Breaks = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_World = new DataGridViewComboBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_RunStop = new DataGridViewButtonColumn();
            kryptonDataGridViewDashboard_TRiBotManager_Notes = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_Status = new DataGridViewTextBoxColumn();
            kryptonDataGridViewDashboard_TRiBotManager_SandboxieNumber = new DataGridViewTextBoxColumn();
            kryptonPanelDashboard = new Krypton.Toolkit.KryptonPanel();
            kryptonButtonNav_Dashboard = new Krypton.Toolkit.KryptonButton();
            kryptonButtonNav_ScriptProfiles = new Krypton.Toolkit.KryptonButton();
            kryptonButtonNav_BreakProfiles = new Krypton.Toolkit.KryptonButton();
            kryptonButtonNav_Settings = new Krypton.Toolkit.KryptonButton();
            kryptonPanelScriptProfiles = new Krypton.Toolkit.KryptonPanel();
            kryptonPanelBreakProfiles = new Krypton.Toolkit.KryptonPanel();
            kryptonButtonBreakProfiles_Save = new Krypton.Toolkit.KryptonButton();
            kryptonPanelSettings = new Krypton.Toolkit.KryptonPanel();
            kryptonButtonSettings_KillAllBotClients = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_Discord = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_BuyProxies = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_CreateAccount = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_BottingGuide = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_SetupGuide = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_VisitWebsite = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_UpdateManager = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_LocalScripts = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_UpdateScripts = new Krypton.Toolkit.KryptonButton();
            kryptonButton1 = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_InstallProxifier = new Krypton.Toolkit.KryptonButton();
            kryptonButtonSettings_DownloadJava = new Krypton.Toolkit.KryptonButton();
            ...
            ((System.ComponentModel.ISupportInitialize)kryptonDataGridViewDashboard_ScriptFactoryManager).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)kryptonDataGridViewDashboard_OSBotManager).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)kryptonDataGridViewDashboard_DreamBotManager).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)kryptonDataGridViewDashboard_TRiBotManager).BeginInit();
            ((System.ComponentModel.ISupportInitialize)kryptonPanelDashboard).BeginInit();
            kryptonPanelDashboard.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)kryptonPanelScriptProfiles).BeginInit();
            kryptonPanelScriptProfiles.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)kryptonPanelBreakProfiles).BeginInit();
            kryptonPanelBreakProfiles.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)kryptonPanelSettings).BeginInit();
            kryptonPanelSettings.SuspendLayout();
            ...
            comboBoxBreakProfiles_SelectBreakFilename.ForeColor = Color.FromArgb(64, 64, 64);
            ...
            comboBoxScriptProfiles_SelectScript.ForeColor = Color.FromArgb(64, 64, 64);
            comboBoxScriptProfiles_SelectScript.FormattingEnabled = true;
            comboBoxScriptProfiles_SelectScript.Items.AddRange(new object[] { "fxAccountBuilder.txt", "fxAccountBuilder-MasterFarmer.txt", "fxAgility-Rooftops.txt", "fxCooking-RangeAndFire.txt", "fxFarming-TitheFarm.txt", "fxFighter-DustDevils.txt", "fxFighter-ElderChaosDruids.txt", "fxFighter-Kurasks.txt", "fxFighter-Vyres.txt", "fxFiremaking-GrandExchange.txt", "fxFletching-Longbows.txt", "fxGeneric.txt", "fxHerblore-CleanHerbs.txt", "fxLOTR-Aragorn.txt", "fxLOTR-Gandalf.txt", "fxMagic-HouseAlcher.txt", "fxMagic-Orber.txt", "fxMiniGames-RoguesDen.txt", "fxMining-AIO.txt", "fxMining-MotherlodeMine.txt", "fxMuler.txt", "fxPrayer-GildedAltar.txt", "fxProgressiveFighter-Magic.txt", "fxProgressiveFighter-Ranged.txt", "fxRunecrafting-Abyss.txt", "fxRunecrafting-Zeah.txt", "fxSlayer-AIO.txt", "fxThieving-MasterFarmers.txt", "fxThieving-Pickpocket.txt", "fxThieving-Vyres.txt", "fxTutorial.txt" });
            ...
            kryptonNavigatorDashboard.Header.HeaderPositionBar = Krypton.Toolkit.VisualOrientation.Top;
            kryptonNavigatorDashboard.Header.HeaderPositionPrimary = Krypton.Toolkit.VisualOrientation.Top;
            kryptonNavigatorDashboard.Header.HeaderPositionSecondary = Krypton.Toolkit.VisualOrientation.Bottom;
            kryptonNavigatorDashboard.Header.HeaderStyleBar = Krypton.Toolkit.HeaderStyle.Primary;
            kryptonNavigatorDashboard.Header.HeaderStylePrimary = Krypton.Toolkit.HeaderStyle.Primary;
            kryptonNavigatorDashboard.Header.HeaderStyleSecondary = Krypton.Toolkit.HeaderStyle.Primary;
            ...
            kryptonNavigatorDashboard.PageBackStyle = Krypton.Toolkit.PaletteBackStyle.ButtonStandalone;
            ...
            kryptonNavigatorDashboard.PaletteMode = Krypton.Toolkit.PaletteMode.Microsoft365DarkGray;
            ...
            kryptonNavigatorDashboard.Stack.BorderEdgeStyle = Krypton.Toolkit.PaletteBorderStyle.ButtonStandalone;
            kryptonNavigatorDashboard.Stack.CheckButtonStyle = Krypton.Toolkit.ButtonStyle.NavigatorStack;
            kryptonNavigatorDashboard.Stack.ItemOrientation = Krypton.Toolkit.ButtonOrientation.Auto;
            kryptonNavigatorDashboard.Stack.StackAlignment = Krypton.Toolkit.RelativePositionAlign.Center;
            ...
            kryptonNavigatorDashboard.StateCommon.HeaderGroup.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonNavigatorDashboard.StateCommon.HeaderGroup.HeaderBar.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonNavigatorDashboard.StateCommon.HeaderGroup.HeaderOverflow.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonNavigatorDashboard.StateCommon.HeaderGroup.HeaderPrimary.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonNavigatorDashboard.StateCommon.HeaderGroup.HeaderPrimary.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonNavigatorDashboard.StateCommon.HeaderGroup.HeaderPrimary.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonNavigatorDashboard.StateCommon.RibbonGeneral.TextHint = Krypton.Toolkit.PaletteTextHint.Inherit;
            ...
            kryptonNavigatorDashboard.StateCommon.Tab.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonNavigatorDashboard.StateCommon.Tab.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonNavigatorDashboard.StateCommon.Tab.Border.Color1 = Color.Gray;
            kryptonNavigatorDashboard.StateCommon.Tab.Border.Color2 = Color.FromArgb(64, 64, 64);
            kryptonNavigatorDashboard.StateCommon.Tab.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonPageDashboard_ScriptFactoryManager.Controls.Add(kryptonDataGridViewDashboard_ScriptFactoryManager);
            ...
            kryptonListBoxDashboard_ScriptFactoryManager_AdditionalSettings.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            kryptonListBoxDashboard_ScriptFactoryManager_AdditionalSettings.StateCommon.Item.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonListBoxDashboard_ScriptFactoryManager_AdditionalSettings.StateCommon.Item.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            labelDashboard_ScriptFactoryManager_AdditionalSettings.Location = new Point(775, 550);
            labelDashboard_ScriptFactoryManager_AdditionalSettings.Name = "labelDashboard_ScriptFactoryManager_AdditionalSettings";
            labelDashboard_ScriptFactoryManager_AdditionalSettings.Size = new Size(350, 25);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_Save.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_Save.Size = new Size(100, 50);
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_Save.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.Size = new Size(100, 50);
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DownloadClient.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.Size = new Size(100, 50);
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_ImportAccounts.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.Size = new Size(100, 50);
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_DeleteAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.Size = new Size(100, 50);
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_AddAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.Size = new Size(100, 50);
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_ScriptFactoryManager_LaunchOSBot.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            // 
            // kryptonDataGridViewDashboard_ScriptFactoryManager
            // 
            kryptonDataGridViewDashboard_ScriptFactoryManager.AllowUserToAddRows = false;
            kryptonDataGridViewDashboard_ScriptFactoryManager.AllowUserToDeleteRows = false;
            kryptonDataGridViewDashboard_ScriptFactoryManager.AllowUserToResizeColumns = false;
            kryptonDataGridViewDashboard_ScriptFactoryManager.AllowUserToResizeRows = false;
            kryptonDataGridViewDashboard_ScriptFactoryManager.BorderStyle = BorderStyle.None;
            kryptonDataGridViewDashboard_ScriptFactoryManager.ClipboardCopyMode = DataGridViewClipboardCopyMode.Disable;
            kryptonDataGridViewDashboard_ScriptFactoryManager.ColumnHeadersHeight = 25;
            kryptonDataGridViewDashboard_ScriptFactoryManager.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            kryptonDataGridViewDashboard_ScriptFactoryManager.Columns.AddRange(new DataGridViewColumn[] { kryptonDataGridViewDashboard_ScriptFactoryManager_Account, kryptonDataGridViewDashboard_ScriptFactory_Password, kryptonDataGridViewDashboard_ScriptFactory_Pin, kryptonDataGridViewDashboard_ScriptFactory_Proxy, kryptonDataGridViewDashboard_ScriptFactory_ScriptFactory, kryptonDataGridViewDashboard_ScriptFactory_Script, kryptonDataGridViewDashboard_ScriptFactory_World, kryptonDataGridViewDashboard_ScriptFactory_RunStop, kryptonDataGridViewDashboard_ScriptFactory_Notes, kryptonDataGridViewDashboard_ScriptFactory_Status, kryptonDataGridViewDashboard_ScriptFactory_SandboxieNumber });
            kryptonDataGridViewDashboard_ScriptFactoryManager.EditMode = DataGridViewEditMode.EditOnEnter;
            kryptonDataGridViewDashboard_ScriptFactoryManager.Location = new Point(5, 5);
            kryptonDataGridViewDashboard_ScriptFactoryManager.Margin = new Padding(0);
            kryptonDataGridViewDashboard_ScriptFactoryManager.MultiSelect = false;
            kryptonDataGridViewDashboard_ScriptFactoryManager.Name = "kryptonDataGridViewDashboard_ScriptFactoryManager";
            kryptonDataGridViewDashboard_ScriptFactoryManager.RowHeadersVisible = false;
            kryptonDataGridViewDashboard_ScriptFactoryManager.RowHeadersWidth = 40;
            kryptonDataGridViewDashboard_ScriptFactoryManager.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            kryptonDataGridViewDashboard_ScriptFactoryManager.RowTemplate.Height = 25;
            kryptonDataGridViewDashboard_ScriptFactoryManager.ScrollBars = ScrollBars.Vertical;
            kryptonDataGridViewDashboard_ScriptFactoryManager.SelectionMode = DataGridViewSelectionMode.CellSelect;
            kryptonDataGridViewDashboard_ScriptFactoryManager.Size = new Size(1137, 525);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StandardTab = true;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.Background.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.Background.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.BackStyle = Krypton.Toolkit.PaletteBackStyle.GridBackgroundList;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.DataCell.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.DataCell.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.DataCell.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.DataCell.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.DataCell.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.DataCell.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.DataCell.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderColumn.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderColumn.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderColumn.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderColumn.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderColumn.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderColumn.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderColumn.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderRow.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderRow.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderRow.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderRow.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderRow.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_ScriptFactoryManager.StateCommon.HeaderRow.Content.Color1 = Color.FromArgb(224, 224, 224);
            ...
            kryptonPageDashboard_OSBotManager.Controls.Add(kryptonDataGridViewDashboard_OSBotManager);
            ...
            kryptonListBoxDashboard_OSBotManager_AdditionalSettings.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            kryptonListBoxDashboard_OSBotManager_AdditionalSettings.StateCommon.Item.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonListBoxDashboard_OSBotManager_AdditionalSettings.StateCommon.Item.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            labelDashboard_OSBotManager_AdditionalSettings.Location = new Point(775, 550);
            labelDashboard_OSBotManager_AdditionalSettings.Name = "labelDashboard_OSBotManager_AdditionalSettings";
            labelDashboard_OSBotManager_AdditionalSettings.Size = new Size(350, 25);
            ...
            kryptonButtonDashboard_OSBotManager_Save.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_Save.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_Save.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_Save.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_Save.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_Save.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_Save.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_Save.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_Save.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_Save.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_Save.Size = new Size(100, 50);
            kryptonButtonDashboard_OSBotManager_Save.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_Save.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_Save.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_Save.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_Save.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_Save.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_Save.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_Save.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_Save.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_Save.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_Save.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_Save.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_Save.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DownloadClient.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DownloadClient.Size = new Size(100, 50);
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DownloadClient.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_ImportAccounts.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_ImportAccounts.Size = new Size(100, 50);
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_ImportAccounts.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DeleteAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DeleteAccount.Size = new Size(100, 50);
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_DeleteAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_AddAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_AddAccount.Size = new Size(100, 50);
            kryptonButtonDashboard_OSBotManager_AddAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_AddAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_AddAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_AddAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_AddAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_AddAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_AddAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.Size = new Size(100, 50);
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_OSBotManager_LaunchOSBot.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            // 
            // kryptonDataGridViewDashboard_OSBotManager
            // 
            kryptonDataGridViewDashboard_OSBotManager.AllowUserToAddRows = false;
            kryptonDataGridViewDashboard_OSBotManager.AllowUserToDeleteRows = false;
            kryptonDataGridViewDashboard_OSBotManager.AllowUserToResizeColumns = false;
            kryptonDataGridViewDashboard_OSBotManager.AllowUserToResizeRows = false;
            kryptonDataGridViewDashboard_OSBotManager.BorderStyle = BorderStyle.None;
            kryptonDataGridViewDashboard_OSBotManager.ClipboardCopyMode = DataGridViewClipboardCopyMode.Disable;
            kryptonDataGridViewDashboard_OSBotManager.ColumnHeadersHeight = 25;
            kryptonDataGridViewDashboard_OSBotManager.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            kryptonDataGridViewDashboard_OSBotManager.Columns.AddRange(new DataGridViewColumn[] { kryptonDataGridViewDashboard_OSBotManager_Account, kryptonDataGridViewDashboard_OSBotManager_Password, kryptonDataGridViewDashboard_OSBotManager_Pin, kryptonDataGridViewDashboard_OSBotManager_Proxy, kryptonDataGridViewDashboard_OSBotManager_Script, kryptonDataGridViewDashboard_OSBotManager_Args, kryptonDataGridViewDashboard_OSBotManager_World, kryptonDataGridViewDashboard_OSBotManager_RunStop, kryptonDataGridViewDashboard_OSBotManager_Notes, kryptonDataGridViewDashboard_OSBotManager_Status, kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber });
            kryptonDataGridViewDashboard_OSBotManager.EditMode = DataGridViewEditMode.EditOnEnter;
            kryptonDataGridViewDashboard_OSBotManager.Location = new Point(5, 5);
            kryptonDataGridViewDashboard_OSBotManager.Margin = new Padding(0);
            kryptonDataGridViewDashboard_OSBotManager.MultiSelect = false;
            kryptonDataGridViewDashboard_OSBotManager.Name = "kryptonDataGridViewDashboard_OSBotManager";
            kryptonDataGridViewDashboard_OSBotManager.RowHeadersVisible = false;
            kryptonDataGridViewDashboard_OSBotManager.RowHeadersWidth = 40;
            kryptonDataGridViewDashboard_OSBotManager.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            kryptonDataGridViewDashboard_OSBotManager.RowTemplate.Height = 25;
            kryptonDataGridViewDashboard_OSBotManager.ScrollBars = ScrollBars.Vertical;
            kryptonDataGridViewDashboard_OSBotManager.SelectionMode = DataGridViewSelectionMode.CellSelect;
            kryptonDataGridViewDashboard_OSBotManager.Size = new Size(1137, 525);
            kryptonDataGridViewDashboard_OSBotManager.StandardTab = true;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.Background.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.Background.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.BackStyle = Krypton.Toolkit.PaletteBackStyle.GridBackgroundList;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.DataCell.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.DataCell.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.DataCell.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.DataCell.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.DataCell.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.DataCell.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.DataCell.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderColumn.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderColumn.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderColumn.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderColumn.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderColumn.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderColumn.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderColumn.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderRow.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderRow.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderRow.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderRow.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderRow.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderRow.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.StateCommon.HeaderRow.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_OSBotManager.TabIndex = 54;
            kryptonDataGridViewDashboard_OSBotManager.CellContentClick += dataGridView_OSBotRun_CellButtonClick;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_Account
            // 
            dataGridViewCellStyle9.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_OSBotManager_Account.DefaultCellStyle = dataGridViewCellStyle9;
            kryptonDataGridViewDashboard_OSBotManager_Account.HeaderText = "Account";
            kryptonDataGridViewDashboard_OSBotManager_Account.Name = "kryptonDataGridViewDashboard_OSBotManager_Account";
            kryptonDataGridViewDashboard_OSBotManager_Account.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_OSBotManager_Account.Width = 150;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_Password
            // 
            dataGridViewCellStyle10.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_OSBotManager_Password.DefaultCellStyle = dataGridViewCellStyle10;
            kryptonDataGridViewDashboard_OSBotManager_Password.HeaderText = "Password";
            kryptonDataGridViewDashboard_OSBotManager_Password.Name = "kryptonDataGridViewDashboard_OSBotManager_Password";
            kryptonDataGridViewDashboard_OSBotManager_Password.Resizable = DataGridViewTriState.True;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_Pin
            // 
            dataGridViewCellStyle11.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_OSBotManager_Pin.DefaultCellStyle = dataGridViewCellStyle11;
            kryptonDataGridViewDashboard_OSBotManager_Pin.HeaderText = "Pin";
            kryptonDataGridViewDashboard_OSBotManager_Pin.Name = "kryptonDataGridViewDashboard_OSBotManager_Pin";
            kryptonDataGridViewDashboard_OSBotManager_Pin.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_OSBotManager_Pin.Width = 75;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_Proxy
            // 
            dataGridViewCellStyle12.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_OSBotManager_Proxy.DefaultCellStyle = dataGridViewCellStyle12;
            kryptonDataGridViewDashboard_OSBotManager_Proxy.HeaderText = "Proxy";
            kryptonDataGridViewDashboard_OSBotManager_Proxy.Name = "kryptonDataGridViewDashboard_OSBotManager_Proxy";
            kryptonDataGridViewDashboard_OSBotManager_Proxy.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_OSBotManager_Proxy.Width = 125;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_Script
            // 
            ...
            kryptonDataGridViewDashboard_OSBotManager_Script.DefaultCellStyle = dataGridViewCellStyle13;
            kryptonDataGridViewDashboard_OSBotManager_Script.HeaderText = "Script";
            kryptonDataGridViewDashboard_OSBotManager_Script.Items.AddRange(new object[] { "SF I", "SF II", "SF Pro", "SF Expansion" });
            kryptonDataGridViewDashboard_OSBotManager_Script.Name = "kryptonDataGridViewDashboard_OSBotManager_Script";
            kryptonDataGridViewDashboard_OSBotManager_Script.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_OSBotManager_Script.SortMode = DataGridViewColumnSortMode.Automatic;
            kryptonDataGridViewDashboard_OSBotManager_Script.Width = 225;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_Args
            // 
            dataGridViewCellStyle14.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_OSBotManager_Args.DefaultCellStyle = dataGridViewCellStyle14;
            kryptonDataGridViewDashboard_OSBotManager_Args.HeaderText = "Args";
            kryptonDataGridViewDashboard_OSBotManager_Args.Name = "kryptonDataGridViewDashboard_OSBotManager_Args";
            kryptonDataGridViewDashboard_OSBotManager_Args.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_OSBotManager_Args.Width = 125;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_World
            // 
            ...
            kryptonDataGridViewDashboard_OSBotManager_World.DefaultCellStyle = dataGridViewCellStyle15;
            kryptonDataGridViewDashboard_OSBotManager_World.HeaderText = "World";
            kryptonDataGridViewDashboard_OSBotManager_World.Items.AddRange(new object[] { "-F2P-", "301", "308", "316", "326", "335", "371", "380", "382", "383", "384", "394", "397", "398", "399", "417", "418", "430", "431", "433", "434", "435", "436", "437", "451", "452", "453", "454", "455", "456", "469", "470", "471", "475", "476", "483", "497", "498", "499", "500", "501", "537", "542", "543", "544", "545", "546", "547", "552", "553", "554", "555", "556", "557", "562", "563", "571", "575", "-P2P-", "302", "303", "304", "305", "306", "307", "309", "310", "311", "312", "313", "314", "315", "317", "318", "319", "320", "321", "322", "323", "324", "325", "327", "328", "329", "330", "331", "332", "333", "334", "336", "337", "338", "339", "340", "341", "343", "344", "346", "347", "348", "350", "351", "352", "354", "355", "357", "358", "359", "360", "362", "367", "368", "369", "370", "374", "375", "376", "377", "378", "386", "387", "388", "389", "390", "395", "421", "422", "424", "443", "444", "445", "446", "463", "464", "465", "466", "477", "478", "480", "481", "482", "484", "485", "486", "487", "488", "489", "490", "491", "492", "493", "494", "495", "496", "505", "506", "507", "508", "509", "510", "511", "512", "513", "514", "515", "516", "517", "518", "519", "520", "521", "522", "523", "524", "525", "531", "532", "533", "534", "535", "580" });
            kryptonDataGridViewDashboard_OSBotManager_World.Name = "kryptonDataGridViewDashboard_OSBotManager_World";
            kryptonDataGridViewDashboard_OSBotManager_World.Width = 85;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_RunStop
            // 
            kryptonDataGridViewDashboard_OSBotManager_RunStop.HeaderText = "Run | Stop";
            kryptonDataGridViewDashboard_OSBotManager_RunStop.Name = "kryptonDataGridViewDashboard_OSBotManager_RunStop";
            kryptonDataGridViewDashboard_OSBotManager_RunStop.Width = 75;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_Notes
            // 
            dataGridViewCellStyle16.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_OSBotManager_Notes.DefaultCellStyle = dataGridViewCellStyle16;
            kryptonDataGridViewDashboard_OSBotManager_Notes.HeaderText = "Notes";
            kryptonDataGridViewDashboard_OSBotManager_Notes.Name = "kryptonDataGridViewDashboard_OSBotManager_Notes";
            kryptonDataGridViewDashboard_OSBotManager_Notes.Resizable = DataGridViewTriState.False;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_Status
            // 
            kryptonDataGridViewDashboard_OSBotManager_Status.HeaderText = "Status";
            kryptonDataGridViewDashboard_OSBotManager_Status.Name = "kryptonDataGridViewDashboard_OSBotManager_Status";
            kryptonDataGridViewDashboard_OSBotManager_Status.ReadOnly = true;
            kryptonDataGridViewDashboard_OSBotManager_Status.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_OSBotManager_Status.Width = 75;
            // 
            // kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber
            // 
            kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber.HeaderText = "Sandboxie Number";
            kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber.Name = "kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber";
            kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber.Visible = false;
            // 
            ...
            kryptonPageDashboard_DreamBotManager.Controls.Add(kryptonDataGridViewDashboard_DreamBotManager);
            ...
            kryptonListBoxDashboard_DreamBotManager_AdditionalSettings.Items.AddRange(new object[] { "Covert", "Fresh Start", "No Render", "Resizable Mode", "Sandboxie" });
            ...
            kryptonListBoxDashboard_DreamBotManager_AdditionalSettings.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            kryptonListBoxDashboard_DreamBotManager_AdditionalSettings.StateCommon.Item.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonListBoxDashboard_DreamBotManager_AdditionalSettings.StateCommon.Item.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            labelButtonDashboard_DreamBotManager_AdditionalSettings.Location = new Point(775, 550);
            labelButtonDashboard_DreamBotManager_AdditionalSettings.Name = "labelButtonDashboard_DreamBotManager_AdditionalSettings";
            labelButtonDashboard_DreamBotManager_AdditionalSettings.Size = new Size(350, 25);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_Save.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_Save.Size = new Size(100, 50);
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_Save.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.Size = new Size(100, 50);
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DownloadClient.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.Size = new Size(100, 50);
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_ImportAccounts.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.Size = new Size(100, 50);
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_DeleteAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.Size = new Size(100, 50);
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonButtonDashboard_DreamBotManager_AddAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.Size = new Size(100, 50);
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_DreamBotManager_LaunchDreamBot.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            // 
            // kryptonDataGridViewDashboard_DreamBotManager
            // 
            kryptonDataGridViewDashboard_DreamBotManager.AllowUserToAddRows = false;
            kryptonDataGridViewDashboard_DreamBotManager.AllowUserToDeleteRows = false;
            kryptonDataGridViewDashboard_DreamBotManager.AllowUserToResizeColumns = false;
            kryptonDataGridViewDashboard_DreamBotManager.AllowUserToResizeRows = false;
            kryptonDataGridViewDashboard_DreamBotManager.BorderStyle = BorderStyle.None;
            kryptonDataGridViewDashboard_DreamBotManager.ClipboardCopyMode = DataGridViewClipboardCopyMode.Disable;
            kryptonDataGridViewDashboard_DreamBotManager.ColumnHeadersHeight = 25;
            kryptonDataGridViewDashboard_DreamBotManager.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            kryptonDataGridViewDashboard_DreamBotManager.Columns.AddRange(new DataGridViewColumn[] { kryptonDataGridViewDashboard_DreamBotManager_Account, kryptonDataGridViewDashboard_DreamBotManager_Password, kryptonDataGridViewDashboard_DreamBotManager_Pin, kryptonDataGridViewDashboard_DreamBotManager_Proxy, kryptonDataGridViewDashboard_DreamBotManager_Script, kryptonDataGridViewDashboard_DreamBotManager_Args, kryptonDataGridViewDashboard_DreamBotManager_Breaks, kryptonDataGridViewDashboard_DreamBotManager_World, kryptonDataGridViewDashboard_DreamBotManager_RunStop, kryptonDataGridViewDashboard_DreamBotManager_Notes, kryptonDataGridViewDashboard_DreamBotManager_Status, kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber });
            kryptonDataGridViewDashboard_DreamBotManager.EditMode = DataGridViewEditMode.EditOnEnter;
            kryptonDataGridViewDashboard_DreamBotManager.Location = new Point(5, 5);
            kryptonDataGridViewDashboard_DreamBotManager.Margin = new Padding(0);
            kryptonDataGridViewDashboard_DreamBotManager.MultiSelect = false;
            kryptonDataGridViewDashboard_DreamBotManager.Name = "kryptonDataGridViewDashboard_DreamBotManager";
            kryptonDataGridViewDashboard_DreamBotManager.RowHeadersVisible = false;
            kryptonDataGridViewDashboard_DreamBotManager.RowHeadersWidth = 40;
            kryptonDataGridViewDashboard_DreamBotManager.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            kryptonDataGridViewDashboard_DreamBotManager.RowTemplate.Height = 25;
            kryptonDataGridViewDashboard_DreamBotManager.ScrollBars = ScrollBars.Vertical;
            kryptonDataGridViewDashboard_DreamBotManager.SelectionMode = DataGridViewSelectionMode.CellSelect;
            kryptonDataGridViewDashboard_DreamBotManager.Size = new Size(1137, 525);
            kryptonDataGridViewDashboard_DreamBotManager.StandardTab = true;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.Background.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.Background.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.BackStyle = Krypton.Toolkit.PaletteBackStyle.GridBackgroundList;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.DataCell.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.DataCell.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.DataCell.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.DataCell.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.DataCell.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.DataCell.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.DataCell.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderColumn.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderColumn.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderColumn.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderColumn.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderColumn.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderColumn.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderColumn.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderRow.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderRow.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderRow.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderRow.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderRow.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderRow.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.StateCommon.HeaderRow.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_DreamBotManager.TabIndex = 81;
            kryptonDataGridViewDashboard_DreamBotManager.CellContentClick += dataGridView_DreamBotRun_CellButtonClick;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Account
            // 
            dataGridViewCellStyle17.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_DreamBotManager_Account.DefaultCellStyle = dataGridViewCellStyle17;
            kryptonDataGridViewDashboard_DreamBotManager_Account.HeaderText = "Account";
            kryptonDataGridViewDashboard_DreamBotManager_Account.Name = "kryptonDataGridViewDashboard_DreamBotManager_Account";
            kryptonDataGridViewDashboard_DreamBotManager_Account.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_DreamBotManager_Account.Width = 150;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Password
            // 
            dataGridViewCellStyle18.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_DreamBotManager_Password.DefaultCellStyle = dataGridViewCellStyle18;
            kryptonDataGridViewDashboard_DreamBotManager_Password.HeaderText = "Password";
            kryptonDataGridViewDashboard_DreamBotManager_Password.Name = "kryptonDataGridViewDashboard_DreamBotManager_Password";
            kryptonDataGridViewDashboard_DreamBotManager_Password.Resizable = DataGridViewTriState.True;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Pin
            // 
            dataGridViewCellStyle19.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_DreamBotManager_Pin.DefaultCellStyle = dataGridViewCellStyle19;
            kryptonDataGridViewDashboard_DreamBotManager_Pin.HeaderText = "Pin";
            kryptonDataGridViewDashboard_DreamBotManager_Pin.Name = "kryptonDataGridViewDashboard_DreamBotManager_Pin";
            kryptonDataGridViewDashboard_DreamBotManager_Pin.Width = 75;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Proxy
            // 
            dataGridViewCellStyle20.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_DreamBotManager_Proxy.DefaultCellStyle = dataGridViewCellStyle20;
            kryptonDataGridViewDashboard_DreamBotManager_Proxy.HeaderText = "Proxy";
            kryptonDataGridViewDashboard_DreamBotManager_Proxy.Name = "kryptonDataGridViewDashboard_DreamBotManager_Proxy";
            kryptonDataGridViewDashboard_DreamBotManager_Proxy.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_DreamBotManager_Proxy.Width = 125;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Script
            // 
            dataGridViewCellStyle21.ForeColor = Color.FromArgb(64, 64, 64);
            dataGridViewCellStyle21.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_DreamBotManager_Script.DefaultCellStyle = dataGridViewCellStyle21;
            kryptonDataGridViewDashboard_DreamBotManager_Script.HeaderText = "Script";
            kryptonDataGridViewDashboard_DreamBotManager_Script.Items.AddRange(new object[] { "SF I", "SF II", "SF Pro", "SF Expansion" });
            kryptonDataGridViewDashboard_DreamBotManager_Script.Name = "kryptonDataGridViewDashboard_DreamBotManager_Script";
            kryptonDataGridViewDashboard_DreamBotManager_Script.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_DreamBotManager_Script.SortMode = DataGridViewColumnSortMode.Automatic;
            kryptonDataGridViewDashboard_DreamBotManager_Script.Width = 225;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Args
            // 
            dataGridViewCellStyle22.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_DreamBotManager_Args.DefaultCellStyle = dataGridViewCellStyle22;
            kryptonDataGridViewDashboard_DreamBotManager_Args.HeaderText = "Args";
            kryptonDataGridViewDashboard_DreamBotManager_Args.Name = "kryptonDataGridViewDashboard_DreamBotManager_Args";
            kryptonDataGridViewDashboard_DreamBotManager_Args.Width = 75;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Breaks
            // 
            dataGridViewCellStyle23.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_DreamBotManager_Breaks.DefaultCellStyle = dataGridViewCellStyle23;
            kryptonDataGridViewDashboard_DreamBotManager_Breaks.HeaderText = "Breaks";
            kryptonDataGridViewDashboard_DreamBotManager_Breaks.Name = "kryptonDataGridViewDashboard_DreamBotManager_Breaks";
            kryptonDataGridViewDashboard_DreamBotManager_Breaks.Width = 75;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_World
            // 
            ...
            kryptonDataGridViewDashboard_DreamBotManager_World.DefaultCellStyle = dataGridViewCellStyle24;
            kryptonDataGridViewDashboard_DreamBotManager_World.HeaderText = "World";
            kryptonDataGridViewDashboard_DreamBotManager_World.Items.AddRange(new object[] { "f2p", "301", "308", "316", "326", "335", "371", "380", "382", "383", "384", "394", "397", "398", "399", "417", "418", "430", "431", "433", "434", "435", "436", "437", "451", "452", "453", "454", "455", "456", "469", "470", "471", "475", "476", "483", "497", "498", "499", "500", "501", "537", "542", "543", "544", "545", "546", "547", "552", "553", "554", "555", "556", "557", "562", "563", "571", "575", "members", "302", "303", "304", "305", "306", "307", "309", "310", "311", "312", "313", "314", "315", "317", "318", "319", "320", "321", "322", "323", "324", "325", "327", "328", "329", "330", "331", "332", "333", "334", "336", "337", "338", "339", "340", "341", "343", "344", "346", "347", "348", "350", "351", "352", "354", "355", "357", "358", "359", "360", "362", "367", "368", "369", "370", "374", "375", "376", "377", "378", "386", "387", "388", "389", "390", "395", "421", "422", "424", "443", "444", "445", "446", "463", "464", "465", "466", "477", "478", "480", "481", "482", "484", "485", "486", "487", "488", "489", "490", "491", "492", "493", "494", "495", "496", "505", "506", "507", "508", "509", "510", "511", "512", "513", "514", "515", "516", "517", "518", "519", "520", "521", "522", "523", "524", "525", "531", "532", "533", "534", "535", "580" });
            kryptonDataGridViewDashboard_DreamBotManager_World.Name = "kryptonDataGridViewDashboard_DreamBotManager_World";
            kryptonDataGridViewDashboard_DreamBotManager_World.Width = 60;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_RunStop
            // 
            kryptonDataGridViewDashboard_DreamBotManager_RunStop.HeaderText = "Run | Stop";
            kryptonDataGridViewDashboard_DreamBotManager_RunStop.Name = "kryptonDataGridViewDashboard_DreamBotManager_RunStop";
            kryptonDataGridViewDashboard_DreamBotManager_RunStop.Width = 75;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Notes
            // 
            dataGridViewCellStyle25.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_DreamBotManager_Notes.DefaultCellStyle = dataGridViewCellStyle25;
            kryptonDataGridViewDashboard_DreamBotManager_Notes.HeaderText = "Notes";
            kryptonDataGridViewDashboard_DreamBotManager_Notes.Name = "kryptonDataGridViewDashboard_DreamBotManager_Notes";
            kryptonDataGridViewDashboard_DreamBotManager_Notes.Resizable = DataGridViewTriState.False;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_Status
            // 
            kryptonDataGridViewDashboard_DreamBotManager_Status.HeaderText = "Status";
            kryptonDataGridViewDashboard_DreamBotManager_Status.Name = "kryptonDataGridViewDashboard_DreamBotManager_Status";
            kryptonDataGridViewDashboard_DreamBotManager_Status.ReadOnly = true;
            kryptonDataGridViewDashboard_DreamBotManager_Status.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_DreamBotManager_Status.Width = 75;
            // 
            // kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber
            // 
            kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber.HeaderText = "Sandboxie Number";
            kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber.Name = "kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber";
            kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber.Visible = false;
            // 
            ...
            kryptonPageDashboard_TRiBotManager.Controls.Add(kryptonDataGridViewDashboard_TRiBotManager);
            ...
            kryptonListBoxDashboard_TRiBotManager_AdditionalSettings.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            kryptonListBoxDashboard_TRiBotManager_AdditionalSettings.StateCommon.Item.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonListBoxDashboard_TRiBotManager_AdditionalSettings.StateCommon.Item.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            labelDashboard_TRiBotManager_AdditionalSettings.Location = new Point(775, 550);
            labelDashboard_TRiBotManager_AdditionalSettings.Name = "labelDashboard_TRiBotManager_AdditionalSettings";
            labelDashboard_TRiBotManager_AdditionalSettings.Size = new Size(350, 25);
            ...
            kryptonButtonDashboard_TRiBotManager_Save.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_Save.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_Save.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_Save.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_Save.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_Save.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_Save.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_Save.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_Save.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_Save.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_Save.Size = new Size(100, 50);
            kryptonButtonDashboard_TRiBotManager_Save.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_Save.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_Save.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_Save.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_Save.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_Save.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_Save.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_Save.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_Save.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_Save.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_Save.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_Save.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_Save.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DownloadClient.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DownloadClient.Size = new Size(100, 50);
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DownloadClient.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.Size = new Size(100, 50);
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_ImportAccounts.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.Size = new Size(100, 50);
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_DeleteAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_AddAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_AddAccount.Size = new Size(100, 50);
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_AddAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_LaunchClient.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_LaunchClient.Size = new Size(100, 50);
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonDashboard_TRiBotManager_LaunchClient.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            // 
            // kryptonDataGridViewDashboard_TRiBotManager
            // 
            kryptonDataGridViewDashboard_TRiBotManager.AllowUserToAddRows = false;
            kryptonDataGridViewDashboard_TRiBotManager.AllowUserToDeleteRows = false;
            kryptonDataGridViewDashboard_TRiBotManager.AllowUserToResizeColumns = false;
            kryptonDataGridViewDashboard_TRiBotManager.AllowUserToResizeRows = false;
            kryptonDataGridViewDashboard_TRiBotManager.BorderStyle = BorderStyle.None;
            kryptonDataGridViewDashboard_TRiBotManager.ClipboardCopyMode = DataGridViewClipboardCopyMode.Disable;
            kryptonDataGridViewDashboard_TRiBotManager.ColumnHeadersHeight = 25;
            kryptonDataGridViewDashboard_TRiBotManager.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            kryptonDataGridViewDashboard_TRiBotManager.Columns.AddRange(new DataGridViewColumn[] { kryptonDataGridViewDashboard_TRiBotManager_Account, kryptonDataGridViewDashboard_TRiBotManager_Password, kryptonDataGridViewDashboard_TRiBotManager_Pin, kryptonDataGridViewDashboard_TRiBotManager_Proxy, kryptonDataGridViewDashboard_TRiBotManager_Script, kryptonDataGridViewDashboard_TRiBotManager_Args, kryptonDataGridViewDashboard_TRiBotManager_Breaks, kryptonDataGridViewDashboard_TRiBotManager_World, kryptonDataGridViewDashboard_TRiBotManager_RunStop, kryptonDataGridViewDashboard_TRiBotManager_Notes, kryptonDataGridViewDashboard_TRiBotManager_Status, kryptonDataGridViewDashboard_TRiBotManager_SandboxieNumber });
            kryptonDataGridViewDashboard_TRiBotManager.EditMode = DataGridViewEditMode.EditOnEnter;
            kryptonDataGridViewDashboard_TRiBotManager.Location = new Point(5, 5);
            kryptonDataGridViewDashboard_TRiBotManager.Margin = new Padding(0);
            kryptonDataGridViewDashboard_TRiBotManager.MultiSelect = false;
            kryptonDataGridViewDashboard_TRiBotManager.Name = "kryptonDataGridViewDashboard_TRiBotManager";
            kryptonDataGridViewDashboard_TRiBotManager.RowHeadersVisible = false;
            kryptonDataGridViewDashboard_TRiBotManager.RowHeadersWidth = 40;
            kryptonDataGridViewDashboard_TRiBotManager.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            kryptonDataGridViewDashboard_TRiBotManager.RowTemplate.Height = 25;
            kryptonDataGridViewDashboard_TRiBotManager.ScrollBars = ScrollBars.Vertical;
            kryptonDataGridViewDashboard_TRiBotManager.SelectionMode = DataGridViewSelectionMode.CellSelect;
            kryptonDataGridViewDashboard_TRiBotManager.Size = new Size(1137, 525);
            kryptonDataGridViewDashboard_TRiBotManager.StandardTab = true;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.Background.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.Background.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.BackStyle = Krypton.Toolkit.PaletteBackStyle.GridBackgroundList;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.DataCell.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.DataCell.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.DataCell.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.DataCell.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.DataCell.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.DataCell.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.DataCell.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderColumn.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderColumn.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderColumn.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderColumn.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderColumn.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderColumn.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderColumn.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderRow.Back.Color1 = Color.Transparent;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderRow.Back.Color2 = Color.Transparent;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderRow.Border.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderRow.Border.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderRow.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderRow.Content.Color1 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.StateCommon.HeaderRow.Content.Color2 = Color.FromArgb(224, 224, 224);
            kryptonDataGridViewDashboard_TRiBotManager.TabIndex = 97;
            kryptonDataGridViewDashboard_TRiBotManager.CellContentClick += dataGridView_TRiBotRun_CellButtonClick;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Account
            // 
            dataGridViewCellStyle26.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_Account.DefaultCellStyle = dataGridViewCellStyle26;
            kryptonDataGridViewDashboard_TRiBotManager_Account.HeaderText = "Account";
            kryptonDataGridViewDashboard_TRiBotManager_Account.Name = "kryptonDataGridViewDashboard_TRiBotManager_Account";
            kryptonDataGridViewDashboard_TRiBotManager_Account.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_TRiBotManager_Account.Width = 150;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Password
            // 
            dataGridViewCellStyle27.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_Password.DefaultCellStyle = dataGridViewCellStyle27;
            kryptonDataGridViewDashboard_TRiBotManager_Password.HeaderText = "Password";
            kryptonDataGridViewDashboard_TRiBotManager_Password.Name = "kryptonDataGridViewDashboard_TRiBotManager_Password";
            kryptonDataGridViewDashboard_TRiBotManager_Password.Resizable = DataGridViewTriState.True;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Pin
            // 
            dataGridViewCellStyle28.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_Pin.DefaultCellStyle = dataGridViewCellStyle28;
            kryptonDataGridViewDashboard_TRiBotManager_Pin.HeaderText = "Pin";
            kryptonDataGridViewDashboard_TRiBotManager_Pin.Name = "kryptonDataGridViewDashboard_TRiBotManager_Pin";
            kryptonDataGridViewDashboard_TRiBotManager_Pin.Width = 75;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Proxy
            // 
            dataGridViewCellStyle29.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_Proxy.DefaultCellStyle = dataGridViewCellStyle29;
            kryptonDataGridViewDashboard_TRiBotManager_Proxy.HeaderText = "Proxy";
            kryptonDataGridViewDashboard_TRiBotManager_Proxy.Name = "kryptonDataGridViewDashboard_TRiBotManager_Proxy";
            kryptonDataGridViewDashboard_TRiBotManager_Proxy.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_TRiBotManager_Proxy.Width = 125;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Script
            // 
            dataGridViewCellStyle30.ForeColor = Color.FromArgb(64, 64, 64);
            dataGridViewCellStyle30.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_Script.DefaultCellStyle = dataGridViewCellStyle30;
            kryptonDataGridViewDashboard_TRiBotManager_Script.HeaderText = "Script";
            kryptonDataGridViewDashboard_TRiBotManager_Script.Items.AddRange(new object[] { "SF I", "SF II", "SF Pro", "SF Expansion" });
            kryptonDataGridViewDashboard_TRiBotManager_Script.Name = "kryptonDataGridViewDashboard_TRiBotManager_Script";
            kryptonDataGridViewDashboard_TRiBotManager_Script.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_TRiBotManager_Script.SortMode = DataGridViewColumnSortMode.Automatic;
            kryptonDataGridViewDashboard_TRiBotManager_Script.Width = 200;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Args
            // 
            dataGridViewCellStyle31.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_Args.DefaultCellStyle = dataGridViewCellStyle31;
            kryptonDataGridViewDashboard_TRiBotManager_Args.HeaderText = "Args";
            kryptonDataGridViewDashboard_TRiBotManager_Args.Name = "kryptonDataGridViewDashboard_TRiBotManager_Args";
            kryptonDataGridViewDashboard_TRiBotManager_Args.Width = 85;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Breaks
            // 
            dataGridViewCellStyle32.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_Breaks.DefaultCellStyle = dataGridViewCellStyle32;
            kryptonDataGridViewDashboard_TRiBotManager_Breaks.HeaderText = "Breaks";
            kryptonDataGridViewDashboard_TRiBotManager_Breaks.Name = "kryptonDataGridViewDashboard_TRiBotManager_Breaks";
            kryptonDataGridViewDashboard_TRiBotManager_Breaks.Width = 75;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_World
            // 
            dataGridViewCellStyle33.ForeColor = Color.FromArgb(64, 64, 64);
            dataGridViewCellStyle33.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_World.DefaultCellStyle = dataGridViewCellStyle33;
            kryptonDataGridViewDashboard_TRiBotManager_World.HeaderText = "World";
            kryptonDataGridViewDashboard_TRiBotManager_World.Items.AddRange(new object[] { "-F2P-", "301", "308", "316", "326", "335", "371", "380", "382", "383", "384", "394", "397", "398", "399", "417", "418", "430", "431", "433", "434", "435", "436", "437", "451", "452", "453", "454", "455", "456", "469", "470", "471", "475", "476", "483", "497", "498", "499", "500", "501", "537", "542", "543", "544", "545", "546", "547", "552", "553", "554", "555", "556", "557", "562", "563", "571", "575", "-P2P-", "302", "303", "304", "305", "306", "307", "309", "310", "311", "312", "313", "314", "315", "317", "318", "319", "320", "321", "322", "323", "324", "325", "327", "328", "329", "330", "331", "332", "333", "334", "336", "337", "338", "339", "340", "341", "343", "344", "346", "347", "348", "350", "351", "352", "354", "355", "357", "358", "359", "360", "362", "367", "368", "369", "370", "374", "375", "376", "377", "378", "386", "387", "388", "389", "390", "395", "421", "422", "424", "443", "444", "445", "446", "463", "464", "465", "466", "477", "478", "480", "481", "482", "484", "485", "486", "487", "488", "489", "490", "491", "492", "493", "494", "495", "496", "505", "506", "507", "508", "509", "510", "511", "512", "513", "514", "515", "516", "517", "518", "519", "520", "521", "522", "523", "524", "525", "531", "532", "533", "534", "535", "580" });
            kryptonDataGridViewDashboard_TRiBotManager_World.Name = "kryptonDataGridViewDashboard_TRiBotManager_World";
            kryptonDataGridViewDashboard_TRiBotManager_World.Width = 75;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_RunStop
            // 
            kryptonDataGridViewDashboard_TRiBotManager_RunStop.HeaderText = "Run | Stop";
            kryptonDataGridViewDashboard_TRiBotManager_RunStop.Name = "kryptonDataGridViewDashboard_TRiBotManager_RunStop";
            kryptonDataGridViewDashboard_TRiBotManager_RunStop.Width = 75;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Notes
            // 
            dataGridViewCellStyle34.SelectionForeColor = Color.FromArgb(64, 64, 64);
            kryptonDataGridViewDashboard_TRiBotManager_Notes.DefaultCellStyle = dataGridViewCellStyle34;
            kryptonDataGridViewDashboard_TRiBotManager_Notes.HeaderText = "Notes";
            kryptonDataGridViewDashboard_TRiBotManager_Notes.Name = "kryptonDataGridViewDashboard_TRiBotManager_Notes";
            kryptonDataGridViewDashboard_TRiBotManager_Notes.Resizable = DataGridViewTriState.False;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_Status
            // 
            kryptonDataGridViewDashboard_TRiBotManager_Status.HeaderText = "Status";
            kryptonDataGridViewDashboard_TRiBotManager_Status.Name = "kryptonDataGridViewDashboard_TRiBotManager_Status";
            kryptonDataGridViewDashboard_TRiBotManager_Status.ReadOnly = true;
            kryptonDataGridViewDashboard_TRiBotManager_Status.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_TRiBotManager_Status.Width = 75;
            // 
            // kryptonDataGridViewDashboard_TRiBotManager_SandboxieNumber
            // 
            kryptonDataGridViewDashboard_TRiBotManager_SandboxieNumber.HeaderText = "Sandboxie Number";
            kryptonDataGridViewDashboard_TRiBotManager_SandboxieNumber.Name = "kryptonDataGridViewDashboard_TRiBotManager_SandboxieNumber";
            kryptonDataGridViewDashboard_TRiBotManager_SandboxieNumber.Resizable = DataGridViewTriState.True;
            kryptonDataGridViewDashboard_TRiBotManager_SandboxieNumber.Visible = false;
            // 
            // kryptonPanelDashboard
            // 
            kryptonPanelDashboard.Controls.Add(kryptonNavigatorDashboard);
            kryptonPanelDashboard.Location = new Point(0, 0);
            kryptonPanelDashboard.Margin = new Padding(0);
            kryptonPanelDashboard.Name = "kryptonPanelDashboard";
            kryptonPanelDashboard.PanelBackStyle = Krypton.Toolkit.PaletteBackStyle.ButtonStandalone;
            kryptonPanelDashboard.Size = new Size(1349, 730);
            kryptonPanelDashboard.StateCommon.Color1 = Color.Transparent;
            kryptonPanelDashboard.StateCommon.Color2 = Color.Transparent;
            kryptonPanelDashboard.TabIndex = 26;
            // 
            ...
            kryptonButtonNav_Dashboard.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
            kryptonButtonNav_Dashboard.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_Dashboard.OverrideDefault.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.OverrideDefault.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.OverrideFocus.Back.Color1 = Color.Silver;
            kryptonButtonNav_Dashboard.OverrideFocus.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Dashboard.OverrideFocus.Back.ColorAngle = 50F;
            kryptonButtonNav_Dashboard.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_Dashboard.OverrideFocus.Border.Draw = Krypton.Toolkit.InheritBool.False;
            kryptonButtonNav_Dashboard.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_Dashboard.OverrideFocus.Border.Rounding = 10F;
            kryptonButtonNav_Dashboard.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Dashboard.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonNav_Dashboard.OverrideFocus.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.OverrideFocus.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_Dashboard.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_Dashboard.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.StateCommon.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.StateDisabled.Back.Color1 = Color.Silver;
            kryptonButtonNav_Dashboard.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Dashboard.StateDisabled.Back.ColorAngle = 50F;
            kryptonButtonNav_Dashboard.StateDisabled.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_Dashboard.StateDisabled.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_Dashboard.StateDisabled.Border.Rounding = 10F;
            kryptonButtonNav_Dashboard.StateDisabled.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Dashboard.StateDisabled.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Dashboard.StateDisabled.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.StateDisabled.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_Dashboard.StateNormal.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_Dashboard.StateNormal.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.StateNormal.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_Dashboard.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_Dashboard.StatePressed.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.StatePressed.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.StateTracking.Back.Color1 = Color.Silver;
            kryptonButtonNav_Dashboard.StateTracking.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Dashboard.StateTracking.Back.ColorAngle = 50F;
            kryptonButtonNav_Dashboard.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_Dashboard.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_Dashboard.StateTracking.Border.Rounding = 10F;
            kryptonButtonNav_Dashboard.StateTracking.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Dashboard.StateTracking.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonNav_Dashboard.StateTracking.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Dashboard.StateTracking.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_ScriptProfiles.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
            kryptonButtonNav_ScriptProfiles.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_ScriptProfiles.OverrideDefault.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.OverrideDefault.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Back.Color1 = Color.Silver;
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Back.ColorAngle = 50F;
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Border.Draw = Krypton.Toolkit.InheritBool.False;
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Border.Rounding = 10F;
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.OverrideFocus.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_ScriptProfiles.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_ScriptProfiles.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.StateCommon.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.StateDisabled.Back.Color1 = Color.Silver;
            kryptonButtonNav_ScriptProfiles.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_ScriptProfiles.StateDisabled.Back.ColorAngle = 50F;
            kryptonButtonNav_ScriptProfiles.StateDisabled.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_ScriptProfiles.StateDisabled.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_ScriptProfiles.StateDisabled.Border.Rounding = 10F;
            kryptonButtonNav_ScriptProfiles.StateDisabled.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_ScriptProfiles.StateDisabled.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_ScriptProfiles.StateDisabled.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.StateDisabled.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_ScriptProfiles.StateNormal.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_ScriptProfiles.StateNormal.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.StateNormal.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_ScriptProfiles.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_ScriptProfiles.StatePressed.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.StatePressed.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.StateTracking.Back.Color1 = Color.Silver;
            kryptonButtonNav_ScriptProfiles.StateTracking.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_ScriptProfiles.StateTracking.Back.ColorAngle = 50F;
            kryptonButtonNav_ScriptProfiles.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_ScriptProfiles.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_ScriptProfiles.StateTracking.Border.Rounding = 10F;
            kryptonButtonNav_ScriptProfiles.StateTracking.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_ScriptProfiles.StateTracking.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonNav_ScriptProfiles.StateTracking.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_ScriptProfiles.StateTracking.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_BreakProfiles.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
            kryptonButtonNav_BreakProfiles.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_BreakProfiles.OverrideDefault.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.OverrideDefault.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.OverrideFocus.Back.Color1 = Color.Silver;
            kryptonButtonNav_BreakProfiles.OverrideFocus.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_BreakProfiles.OverrideFocus.Back.ColorAngle = 50F;
            kryptonButtonNav_BreakProfiles.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_BreakProfiles.OverrideFocus.Border.Draw = Krypton.Toolkit.InheritBool.False;
            kryptonButtonNav_BreakProfiles.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_BreakProfiles.OverrideFocus.Border.Rounding = 10F;
            kryptonButtonNav_BreakProfiles.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_BreakProfiles.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonNav_BreakProfiles.OverrideFocus.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.OverrideFocus.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_BreakProfiles.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_BreakProfiles.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.StateCommon.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.StateDisabled.Back.Color1 = Color.Silver;
            kryptonButtonNav_BreakProfiles.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_BreakProfiles.StateDisabled.Back.ColorAngle = 50F;
            kryptonButtonNav_BreakProfiles.StateDisabled.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_BreakProfiles.StateDisabled.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_BreakProfiles.StateDisabled.Border.Rounding = 10F;
            kryptonButtonNav_BreakProfiles.StateDisabled.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_BreakProfiles.StateDisabled.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_BreakProfiles.StateDisabled.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.StateDisabled.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_BreakProfiles.StateNormal.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_BreakProfiles.StateNormal.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.StateNormal.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_BreakProfiles.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_BreakProfiles.StatePressed.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.StatePressed.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.StateTracking.Back.Color1 = Color.Silver;
            kryptonButtonNav_BreakProfiles.StateTracking.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_BreakProfiles.StateTracking.Back.ColorAngle = 50F;
            kryptonButtonNav_BreakProfiles.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_BreakProfiles.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_BreakProfiles.StateTracking.Border.Rounding = 10F;
            kryptonButtonNav_BreakProfiles.StateTracking.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_BreakProfiles.StateTracking.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonNav_BreakProfiles.StateTracking.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_BreakProfiles.StateTracking.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_Settings.OverrideDefault.Border.Draw = Krypton.Toolkit.InheritBool.False;
            kryptonButtonNav_Settings.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_Settings.OverrideDefault.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.OverrideDefault.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.OverrideFocus.Back.Color1 = Color.Silver;
            kryptonButtonNav_Settings.OverrideFocus.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Settings.OverrideFocus.Back.ColorAngle = 50F;
            kryptonButtonNav_Settings.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_Settings.OverrideFocus.Border.Draw = Krypton.Toolkit.InheritBool.False;
            kryptonButtonNav_Settings.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_Settings.OverrideFocus.Border.Rounding = 10F;
            kryptonButtonNav_Settings.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Settings.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonNav_Settings.OverrideFocus.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.OverrideFocus.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_Settings.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_Settings.StateCommon.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.StateCommon.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.StateDisabled.Back.Color1 = Color.Silver;
            kryptonButtonNav_Settings.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Settings.StateDisabled.Back.ColorAngle = 50F;
            kryptonButtonNav_Settings.StateDisabled.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_Settings.StateDisabled.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_Settings.StateDisabled.Border.Rounding = 10F;
            kryptonButtonNav_Settings.StateDisabled.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Settings.StateDisabled.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Settings.StateDisabled.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.StateDisabled.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_Settings.StateNormal.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_Settings.StateNormal.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.StateNormal.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            kryptonButtonNav_Settings.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonNav_Settings.StatePressed.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.StatePressed.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.StateTracking.Back.Color1 = Color.Silver;
            kryptonButtonNav_Settings.StateTracking.Back.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Settings.StateTracking.Back.ColorAngle = 50F;
            kryptonButtonNav_Settings.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            ...
            kryptonButtonNav_Settings.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonNav_Settings.StateTracking.Border.Rounding = 10F;
            kryptonButtonNav_Settings.StateTracking.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonNav_Settings.StateTracking.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonNav_Settings.StateTracking.Content.ShortText.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            kryptonButtonNav_Settings.StateTracking.Content.ShortText.TextV = Krypton.Toolkit.PaletteRelativeAlign.Center;
            ...
            // 
            // kryptonPanelScriptProfiles
            // 
            kryptonPanelScriptProfiles.Controls.Add(labelScriptProfiles_Header);
            kryptonPanelScriptProfiles.Controls.Add(linkLabelScriptProfilesWebpage);
            kryptonPanelScriptProfiles.Controls.Add(comboBoxScriptProfiles_SelectScript);
            kryptonPanelScriptProfiles.Controls.Add(labelScriptProfiles_Explanation5);
            kryptonPanelScriptProfiles.Controls.Add(labelScriptProfiles_SelectScript);
            kryptonPanelScriptProfiles.Controls.Add(labelScriptProfiles_Explanation4);
            kryptonPanelScriptProfiles.Controls.Add(labelScriptProfiles_Explanation1);
            kryptonPanelScriptProfiles.Controls.Add(labelScriptProfiles_Explanation2);
            kryptonPanelScriptProfiles.Location = new Point(0, 0);
            kryptonPanelScriptProfiles.Margin = new Padding(0);
            kryptonPanelScriptProfiles.Name = "kryptonPanelScriptProfiles";
            kryptonPanelScriptProfiles.PanelBackStyle = Krypton.Toolkit.PaletteBackStyle.ButtonStandalone;
            kryptonPanelScriptProfiles.Size = new Size(1349, 730);
            kryptonPanelScriptProfiles.StateCommon.Color1 = Color.Transparent;
            kryptonPanelScriptProfiles.StateCommon.Color2 = Color.Transparent;
            kryptonPanelScriptProfiles.TabIndex = 27;
            // 
            // kryptonPanelBreakProfiles
            // 
            kryptonPanelBreakProfiles.Controls.Add(kryptonButtonBreakProfiles_Save);
            kryptonPanelBreakProfiles.Controls.Add(labelBreakProfiles_Header);
            kryptonPanelBreakProfiles.Controls.Add(labelSleepTimeVariationPercentage);
            kryptonPanelBreakProfiles.Controls.Add(checkBoxBreakProfiles_EnableBreaks);
            kryptonPanelBreakProfiles.Controls.Add(labelTimeUntilSleepVariationMinutes);
            kryptonPanelBreakProfiles.Controls.Add(checkBoxBreakProfiles_EnableSleepBreaks);
            kryptonPanelBreakProfiles.Controls.Add(labelSleepTimeMinutes);
            kryptonPanelBreakProfiles.Controls.Add(textBoxBreakProfiles_BotTime);
            kryptonPanelBreakProfiles.Controls.Add(labelTimeUntilSleepMinutes);
            kryptonPanelBreakProfiles.Controls.Add(textBoxBreakProfiles_BotTimeVariation);
            kryptonPanelBreakProfiles.Controls.Add(textBoxBreakProfiles_TimeUntilSleep);
            kryptonPanelBreakProfiles.Controls.Add(labelBotTime);
            kryptonPanelBreakProfiles.Controls.Add(textBoxBreakProfiles_TimeUntilSleepVariation);
            kryptonPanelBreakProfiles.Controls.Add(labelBotTimeVariation);
            kryptonPanelBreakProfiles.Controls.Add(textBoxBreakProfiles_SleepTime);
            kryptonPanelBreakProfiles.Controls.Add(labelBotTimeVariationMinutes);
            kryptonPanelBreakProfiles.Controls.Add(textBoxBreakProfiles_SleepTimeVariation);
            kryptonPanelBreakProfiles.Controls.Add(labelBotTimeMinutes);
            kryptonPanelBreakProfiles.Controls.Add(labelSleepTimeVariation);
            kryptonPanelBreakProfiles.Controls.Add(labelBreakTime);
            kryptonPanelBreakProfiles.Controls.Add(labelSleepTime);
            kryptonPanelBreakProfiles.Controls.Add(labelBreakTimeVariation);
            kryptonPanelBreakProfiles.Controls.Add(labelTimeUntilSleepVariation);
            kryptonPanelBreakProfiles.Controls.Add(textBoxBreakProfiles_BreakTime);
            kryptonPanelBreakProfiles.Controls.Add(labelTimeUntilSleep);
            kryptonPanelBreakProfiles.Controls.Add(textBoxBreakProfiles_BreakTimeVariation);
            kryptonPanelBreakProfiles.Controls.Add(labelBreakTImeMinutes);
            kryptonPanelBreakProfiles.Controls.Add(comboBoxBreakProfiles_SelectBreakFilename);
            kryptonPanelBreakProfiles.Controls.Add(labelBreakTimePercentage);
            kryptonPanelBreakProfiles.Location = new Point(0, 0);
            kryptonPanelBreakProfiles.Margin = new Padding(0);
            kryptonPanelBreakProfiles.Name = "kryptonPanelBreakProfiles";
            kryptonPanelBreakProfiles.PanelBackStyle = Krypton.Toolkit.PaletteBackStyle.ButtonStandalone;
            kryptonPanelBreakProfiles.Size = new Size(1349, 730);
            kryptonPanelBreakProfiles.StateCommon.Color1 = Color.Transparent;
            kryptonPanelBreakProfiles.StateCommon.Color2 = Color.Transparent;
            kryptonPanelBreakProfiles.TabIndex = 28;
            // 
            ...
            kryptonButtonBreakProfiles_Save.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonBreakProfiles_Save.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonBreakProfiles_Save.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonBreakProfiles_Save.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonBreakProfiles_Save.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonBreakProfiles_Save.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonBreakProfiles_Save.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonBreakProfiles_Save.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonBreakProfiles_Save.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonBreakProfiles_Save.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonBreakProfiles_Save.Size = new Size(100, 50);
            kryptonButtonBreakProfiles_Save.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonBreakProfiles_Save.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonBreakProfiles_Save.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonBreakProfiles_Save.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonBreakProfiles_Save.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonBreakProfiles_Save.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonBreakProfiles_Save.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonBreakProfiles_Save.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonBreakProfiles_Save.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonBreakProfiles_Save.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonBreakProfiles_Save.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonBreakProfiles_Save.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonBreakProfiles_Save.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            // 
            // kryptonPanelSettings
            // 
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_KillAllBotClients);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_Discord);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_BuyProxies);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_CreateAccount);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_BottingGuide);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_SetupGuide);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_VisitWebsite);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_UpdateManager);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_LocalScripts);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_UpdateScripts);
            kryptonPanelSettings.Controls.Add(kryptonButton1);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_InstallProxifier);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_DownloadJava);
            kryptonPanelSettings.Controls.Add(kryptonButtonSettings_SaveLogin);
            kryptonPanelSettings.Controls.Add(checkBoxSettings_ShowCpuAndRamUsage);
            kryptonPanelSettings.Controls.Add(labelSettings_Header);
            kryptonPanelSettings.Controls.Add(checkBoxSettings_ShowWelcomeScreen);
            kryptonPanelSettings.Controls.Add(textBoxSettings_TRiBotPassword);
            kryptonPanelSettings.Controls.Add(textBoxSettings_TRiBotEmail);
            kryptonPanelSettings.Controls.Add(labelSettings_TRiBotPassword);
            kryptonPanelSettings.Controls.Add(labelSettings_OSBotDetails);
            kryptonPanelSettings.Controls.Add(labelSettings_TRiBotEmail);
            kryptonPanelSettings.Controls.Add(labelSettings_OSBotUsername);
            kryptonPanelSettings.Controls.Add(labelSettings_TRiBotDetails);
            kryptonPanelSettings.Controls.Add(textBoxSettings_OSBotUsername);
            kryptonPanelSettings.Controls.Add(textBoxSettings_DreamBotPassword);
            kryptonPanelSettings.Controls.Add(labelSettings_OSBotPassword);
            kryptonPanelSettings.Controls.Add(textBoxSettings_DreamBotUsername);
            kryptonPanelSettings.Controls.Add(textBoxSettings_OSBotPassword);
            kryptonPanelSettings.Controls.Add(labelSettings_DreamBotPassword);
            kryptonPanelSettings.Controls.Add(labelSettings_DreamBotDetails);
            kryptonPanelSettings.Controls.Add(labelSettings_DreamBotUsername);
            kryptonPanelSettings.Location = new Point(0, 0);
            kryptonPanelSettings.Margin = new Padding(0);
            kryptonPanelSettings.Name = "kryptonPanelSettings";
            kryptonPanelSettings.PanelBackStyle = Krypton.Toolkit.PaletteBackStyle.ButtonStandalone;
            kryptonPanelSettings.Size = new Size(1349, 730);
            kryptonPanelSettings.StateCommon.Color1 = Color.Transparent;
            kryptonPanelSettings.StateCommon.Color2 = Color.Transparent;
            kryptonPanelSettings.TabIndex = 29;
            // 
            ...
            kryptonButtonSettings_KillAllBotClients.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_KillAllBotClients.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_KillAllBotClients.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_KillAllBotClients.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_KillAllBotClients.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_KillAllBotClients.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_KillAllBotClients.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_KillAllBotClients.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_KillAllBotClients.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_KillAllBotClients.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_KillAllBotClients.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_KillAllBotClients.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_KillAllBotClients.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_KillAllBotClients.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_KillAllBotClients.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_Discord.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_Discord.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_Discord.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_Discord.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_Discord.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_Discord.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_Discord.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_Discord.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_Discord.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_Discord.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_Discord.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_Discord.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_Discord.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_Discord.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_Discord.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_BuyProxies.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BuyProxies.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_BuyProxies.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_BuyProxies.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BuyProxies.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_BuyProxies.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_BuyProxies.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BuyProxies.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_BuyProxies.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_BuyProxies.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_BuyProxies.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BuyProxies.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_BuyProxies.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BuyProxies.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BuyProxies.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_CreateAccount.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_CreateAccount.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_CreateAccount.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_CreateAccount.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_CreateAccount.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_CreateAccount.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_CreateAccount.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_CreateAccount.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_CreateAccount.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_CreateAccount.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_CreateAccount.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_CreateAccount.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_CreateAccount.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_CreateAccount.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_CreateAccount.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_BottingGuide.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BottingGuide.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_BottingGuide.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_BottingGuide.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BottingGuide.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_BottingGuide.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_BottingGuide.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BottingGuide.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_BottingGuide.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_BottingGuide.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_BottingGuide.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BottingGuide.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_BottingGuide.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_BottingGuide.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_BottingGuide.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_SetupGuide.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SetupGuide.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_SetupGuide.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SetupGuide.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SetupGuide.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_SetupGuide.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SetupGuide.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SetupGuide.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_SetupGuide.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SetupGuide.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SetupGuide.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SetupGuide.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_SetupGuide.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SetupGuide.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SetupGuide.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_VisitWebsite.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_VisitWebsite.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_VisitWebsite.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_VisitWebsite.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_VisitWebsite.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_VisitWebsite.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_VisitWebsite.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_VisitWebsite.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_VisitWebsite.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_VisitWebsite.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_VisitWebsite.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_VisitWebsite.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_VisitWebsite.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_VisitWebsite.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_VisitWebsite.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_UpdateManager.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateManager.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_UpdateManager.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_UpdateManager.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateManager.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_UpdateManager.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_UpdateManager.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateManager.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_UpdateManager.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_UpdateManager.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_UpdateManager.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateManager.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_UpdateManager.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateManager.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateManager.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_LocalScripts.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_LocalScripts.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_LocalScripts.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_LocalScripts.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_LocalScripts.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_LocalScripts.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_LocalScripts.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_LocalScripts.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_LocalScripts.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_LocalScripts.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_LocalScripts.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_LocalScripts.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_LocalScripts.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_LocalScripts.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_LocalScripts.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_UpdateScripts.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateScripts.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_UpdateScripts.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_UpdateScripts.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateScripts.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_UpdateScripts.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_UpdateScripts.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateScripts.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_UpdateScripts.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_UpdateScripts.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_UpdateScripts.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateScripts.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_UpdateScripts.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_UpdateScripts.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_UpdateScripts.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButton1.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButton1.OverrideDefault.Back.Color2 = SystemColors.ScrollBar;
            kryptonButton1.OverrideDefault.Back.ColorAngle = 50F;
            kryptonButton1.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButton1.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButton1.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButton1.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButton1.OverrideFocus.Back.Color2 = SystemColors.ScrollBar;
            kryptonButton1.OverrideFocus.Back.ColorAngle = 50F;
            kryptonButton1.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButton1.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButton1.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButton1.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButton1.StateCommon.Back.Color2 = SystemColors.ScrollBar;
            kryptonButton1.StateCommon.Back.ColorAngle = 50F;
            kryptonButton1.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButton1.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButton1.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButton1.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButton1.StatePressed.Back.Color2 = SystemColors.ScrollBar;
            kryptonButton1.StatePressed.Back.ColorAngle = 50F;
            kryptonButton1.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButton1.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButton1.StateTracking.Back.Color2 = SystemColors.ScrollBar;
            kryptonButton1.StateTracking.Back.ColorAngle = 50F;
            kryptonButton1.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_InstallProxifier.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_InstallProxifier.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_InstallProxifier.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_InstallProxifier.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_InstallProxifier.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_InstallProxifier.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_InstallProxifier.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_InstallProxifier.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_InstallProxifier.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_InstallProxifier.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_InstallProxifier.Size = new Size(100, 50);
            kryptonButtonSettings_InstallProxifier.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_InstallProxifier.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_InstallProxifier.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_InstallProxifier.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_InstallProxifier.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_InstallProxifier.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_InstallProxifier.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_InstallProxifier.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_InstallProxifier.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_InstallProxifier.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_InstallProxifier.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_InstallProxifier.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_InstallProxifier.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_DownloadJava.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_DownloadJava.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_DownloadJava.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_DownloadJava.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_DownloadJava.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_DownloadJava.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_DownloadJava.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_DownloadJava.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_DownloadJava.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_DownloadJava.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_DownloadJava.Size = new Size(100, 50);
            kryptonButtonSettings_DownloadJava.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_DownloadJava.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_DownloadJava.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_DownloadJava.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_DownloadJava.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_DownloadJava.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_DownloadJava.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_DownloadJava.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_DownloadJava.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_DownloadJava.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_DownloadJava.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_DownloadJava.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_DownloadJava.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            kryptonButtonSettings_SaveLogin.OverrideDefault.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SaveLogin.OverrideDefault.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SaveLogin.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_SaveLogin.OverrideDefault.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SaveLogin.OverrideDefault.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SaveLogin.OverrideFocus.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SaveLogin.OverrideFocus.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SaveLogin.OverrideFocus.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_SaveLogin.OverrideFocus.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SaveLogin.OverrideFocus.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SaveLogin.Size = new Size(100, 50);
            kryptonButtonSettings_SaveLogin.StateCommon.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SaveLogin.StateCommon.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SaveLogin.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_SaveLogin.StateCommon.Content.ShortText.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SaveLogin.StateCommon.Content.ShortText.Color2 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SaveLogin.StateDisabled.Back.Color1 = Color.FromArgb(64, 64, 64);
            kryptonButtonSettings_SaveLogin.StateDisabled.Back.Color2 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SaveLogin.StatePressed.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SaveLogin.StatePressed.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SaveLogin.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            kryptonButtonSettings_SaveLogin.StateTracking.Back.Color1 = Color.FromArgb(64, 64, 64);
            ...
            kryptonButtonSettings_SaveLogin.StateTracking.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.Sigma;
            ...
            kryptonButtonSettings_SaveLogin.StateTracking.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            ...
            // kryptonPanelMain
            // 
            kryptonPanelMain.Controls.Add(labelNav_RamUsageMonitor);
            kryptonPanelMain.Controls.Add(labelNav_CpuUsageMonitor);
            kryptonPanelMain.Controls.Add(buttonNav_JivaroLogo);
            kryptonPanelMain.Controls.Add(labelNav_Jivaro);
            kryptonPanelMain.Controls.Add(labelNav_ByFushigiBot);
            kryptonPanelMain.Controls.Add(labelNav_OSRSLauncher);
            kryptonPanelMain.Controls.Add(kryptonButtonNav_Dashboard);
            kryptonPanelMain.Controls.Add(kryptonButtonNav_ScriptProfiles);
            kryptonPanelMain.Controls.Add(kryptonButtonNav_BreakProfiles);
            kryptonPanelMain.Controls.Add(kryptonButtonNav_Settings);
            kryptonPanelMain.Controls.Add(kryptonProgressBarGlobal);
            kryptonPanelMain.Controls.Add(kryptonPanelDashboard);
            kryptonPanelMain.Controls.Add(kryptonPanelSettings);
            kryptonPanelMain.Controls.Add(kryptonPanelBreakProfiles);
            kryptonPanelMain.Controls.Add(kryptonPanelScriptProfiles);
            kryptonPanelMain.Location = new Point(0, 0);
            kryptonPanelMain.Margin = new Padding(0);
            kryptonPanelMain.Name = "kryptonPanelMain";
            kryptonPanelMain.PanelBackStyle = Krypton.Toolkit.PaletteBackStyle.ButtonStandalone;
            kryptonPanelMain.Size = new Size(1349, 730);
            kryptonPanelMain.StateCommon.Color1 = Color.FromArgb(75, 75, 75);
            kryptonPanelMain.StateCommon.Color2 = Color.FromArgb(25, 25, 25);
            kryptonPanelMain.StateCommon.ColorAngle = 50F;
            kryptonPanelMain.StateCommon.ColorStyle = Krypton.Toolkit.PaletteColorStyle.LinearShadow;
            kryptonPanelMain.TabIndex = 38;
            // 
            ...
            kryptonProgressBarGlobal.StateDisabled.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.OneNote;
            kryptonProgressBarGlobal.StateNormal.Back.ColorStyle = Krypton.Toolkit.PaletteColorStyle.OneNote;
            ...
            ((System.ComponentModel.ISupportInitialize)kryptonDataGridViewDashboard_ScriptFactoryManager).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)kryptonDataGridViewDashboard_OSBotManager).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)kryptonDataGridViewDashboard_DreamBotManager).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)kryptonDataGridViewDashboard_TRiBotManager).EndInit();
            ((System.ComponentModel.ISupportInitialize)kryptonPanelDashboard).EndInit();
            kryptonPanelDashboard.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)kryptonPanelScriptProfiles).EndInit();
            kryptonPanelScriptProfiles.ResumeLayout(false);
            kryptonPanelScriptProfiles.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)kryptonPanelBreakProfiles).EndInit();
            kryptonPanelBreakProfiles.ResumeLayout(false);
            kryptonPanelBreakProfiles.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)kryptonPanelSettings).EndInit();
            kryptonPanelSettings.ResumeLayout(false);
            kryptonPanelSettings.PerformLayout();
        ...
        public DataGridViewComboBoxColumn Column1;
        ...
        public Krypton.Toolkit.KryptonPanel kryptonPanelDashboard;
        ...
        public Krypton.Toolkit.KryptonPanel kryptonPanelScriptProfiles;
        public Krypton.Toolkit.KryptonPanel kryptonPanelBreakProfiles;
        public Krypton.Toolkit.KryptonPanel kryptonPanelSettings;
        public KryptonPage kryptonPageDashboard_TRiBotManager;
        public Krypton.Toolkit.KryptonDataGridView kryptonDataGridViewDashboard_ScriptFactoryManager;
        ...
        public Krypton.Toolkit.KryptonDataGridView kryptonDataGridViewDashboard_OSBotManager;
        ...
        public Krypton.Toolkit.KryptonDataGridView kryptonDataGridViewDashboard_DreamBotManager;
        ...
        public Krypton.Toolkit.KryptonDataGridView kryptonDataGridViewDashboard_TRiBotManager;
        ...
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_OSBotManager_Proxy;
        private DataGridViewComboBoxColumn kryptonDataGridViewDashboard_OSBotManager_Script;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_OSBotManager_Args;
        private DataGridViewComboBoxColumn kryptonDataGridViewDashboard_OSBotManager_World;
        private DataGridViewButtonColumn kryptonDataGridViewDashboard_OSBotManager_RunStop;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_OSBotManager_Notes;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_OSBotManager_Status;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_OSBotManager_SandboxieNumber;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Account;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Password;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Pin;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Proxy;
        private DataGridViewComboBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Script;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Args;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Breaks;
        private DataGridViewComboBoxColumn kryptonDataGridViewDashboard_DreamBotManager_World;
        private DataGridViewButtonColumn kryptonDataGridViewDashboard_DreamBotManager_RunStop;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Notes;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_Status;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_DreamBotManager_SandboxieNumber;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_TRiBotManager_Account;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_TRiBotManager_Password;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_TRiBotManager_Pin;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_TRiBotManager_Proxy;
        private DataGridViewComboBoxColumn kryptonDataGridViewDashboard_TRiBotManager_Script;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_TRiBotManager_Args;
        private DataGridViewTextBoxColumn kryptonDataGridViewDashboard_TRiBotManager_Breaks;
        private DataGridViewComboBoxColumn kryptonDataGridViewDashboard_TRiBotManager_World;
        private DataGridViewButtonColumn kryptonDataGridViewDashboard_TRiBotManager_RunStop;
