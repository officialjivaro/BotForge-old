...
{
    public partial class formScriptProfilesCookingAIO : Form
    {

        // Initialize Instances
        public formMainForm MainForm;

        public formScriptProfilesCookingAIO(formMainForm mainForm)
        {
            InitializeComponent();
            MainForm = mainForm;
        }
        ...
        string filepathProfileCookingRangeAndFire = Path.Combine(@"C:\\Users\\" + Environment.UserName.ToString() + "\\OSBot\\Data\\ProjectPact\\OSRS Script Factory\\Profiles\\fxCooking-AIO.txt");
